  ...
  const services = [
    {
      ...
      description: 'Te ayudamos a entender cómo está tu negocio hoy, qué frena su crecimiento y por dónde empezar a mejorar.',
      features: ['Análisis completo del negocio', 'Plan de acción para 6 a 12 meses', 'Estrategia adaptada a tu realidad'],
      forWho: 'Emprendedores y empresas que sienten que “algo no cierra” pero no saben por dónde empezar.',
      result: 'Estrategia clara y plan de acción.',
      price: 'Desde 50 USD',
      color: 'emerald'
    },
    {
      ...
      description: 'Creamos sitios simples, modernos y estratégicos. No solo se ven bien: venden.',
    ...
    },
    {
      ...
      subtitle: 'Publicidad que generan resultados',
      description: 'Publicidad digital pensada para lo que importa: que entren clientes. No usamos palabras lindas, usamos métricas que te hacen crecer.',
      ...
      price: 'Desde 100 USD + inversión publicitaria',
      color: 'purple'
    },
    {
      icon: Package,
      ...
      description: 'Si necesitás de todo un poco, tenemos combos con más impacto y menos vueltas.',
    ...
    },
    {
      ...
      description: 'Soluciones 100% hechas para vos. Porque cada negocio es distinto.',
